# VERWORFEN – Server-Anforderung für konfigurierbare Sessionprofile

> **Status:** verworfener historischer Entwurf; nicht implementieren  
> **Version:** 1.0  
> **Stand:** 25. Juli 2026  
> **Verworfen am:** 25. Juli 2026  
> **Grund:** Die Serverprüfung ergab, dass echte per-Session-Profile eine
> grundlegende Umgestaltung der Serverarchitektur erfordern würden. Diese
> konkrete Variante wurde deshalb aus dem aktuellen Projektumfang entfernt.
> Eine mögliche Alternativlösung und die endgültige Architekturentscheidung
> sind noch offen und werden erst nach gesonderter Besprechung dokumentiert.
>
> **Wichtig:** Diese Datei liegt ausschließlich als Entscheidungsbeleg im
> Archiv. Sie ist keine Anforderung und keine aktive Protokollspezifikation.
