...
Hier beschrieben wird der ursprüngliche Änderungsplan für den Server.
Das Konzept ist mittlerweile weitgehend umgesetzt und in der Live-Version des Servers verfügbar.
```
