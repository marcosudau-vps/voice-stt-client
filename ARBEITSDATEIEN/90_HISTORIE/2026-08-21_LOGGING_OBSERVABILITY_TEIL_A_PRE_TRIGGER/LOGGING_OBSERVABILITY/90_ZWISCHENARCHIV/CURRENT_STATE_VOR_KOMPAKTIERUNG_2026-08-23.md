> **Provenienzhinweis (OBS-CLOSE-001, 2026-08-23):** Dies ist eine byte-identische
> Kopie des globalen `ARBEITSDATEIEN/00_STEUERUNG/CURRENT_STATE.md` unmittelbar
> **vor** der im Zuge dieses Abschlussruns durchgeführten Kompaktierung. Die
> detaillierte Gate-für-Gate-Historie ist damit vollständig erhalten, auch nachdem
> die aktive `CURRENT_STATE.md` auf einen kompakten aktuellen Snapshot reduziert
> wurde. Diese Kopie besitzt ausschließlich historischen Charakter; die
> weiterhin autoritative, veränderliche Version liegt unter
> `ARBEITSDATEIEN/00_STEUERUNG/CURRENT_STATE.md`. SHA-256 dieser Datei zum
> Zeitpunkt der Kopie: `a9dc674d5e00ff2b691c9650e4b2507f5d079df8a36b841040698d014b5e12cb`
> (identisch mit dem globalen Original vor der Kompaktierung).
