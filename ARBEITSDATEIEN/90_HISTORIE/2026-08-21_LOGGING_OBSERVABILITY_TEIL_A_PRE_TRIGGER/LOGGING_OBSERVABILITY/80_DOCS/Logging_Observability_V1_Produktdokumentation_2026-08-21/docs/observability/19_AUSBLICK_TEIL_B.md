...
Der Logging-Workstream bleibt organisatorisch aktiv, wird aber nach diesem V1-Teilabschluss pausiert, bis die Trigger-/Session-Migration stabil genug ist, um die Post-Migration-Instrumentierung sinnvoll abzuschließen.
